const SchemaNumber = require('../../../../lib/db/schema/SchemaTypes/SchemaNumber')
...
test('SchemaNumber.validate(): #null should return null value', () => {
    ...
    expect(() => nullValue1.validate('str')).toThrow(`Expected property 'nullValue' to be type number, received: string`)
    expect(() => nullValue2.validate('str')).toThrow(`Expected property 'nullValue' to be type number, received: string`)
})
