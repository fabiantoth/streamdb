...
test('4 -> Server: GET /api/collection - Should get all 4 documents', async (done) => {
    setTimeout(async () => {
...
test('5 -> Server: PUT /api/collection - Should update 2 documents', async (done) => {
    const updates = [
        {
            id: 3,
            emptyArray: [0,1],
...
test('6 -> Server: GET /api/collection/_q/? - where() queries', async (done) => {
...
test('7 -> Server: GET /api/collection/_q/? - where().and() queries', async (done) => {
...
test('8 -> Server: GET /api/collection/_q/? - where().or() queries', async (done) => {
...
test('9 -> Server: GET /api/collection/_q/? - where().and().or() queries', async (done) => {
...
test('10 -> Server: GET /api/collection/_q/? - where(exp, filterFn) queries', async (done) => {
...
test('11 -> Server: GET /api/collection/_q/? - where(exp, filterFn).where() queries', async (done) => {
...
test('13 -> Server: GET /api/collection/_q/? - where()/.limit()/.offset() queries', async (done) => {
...
test('14 -> Server: GET /api/collection/_q/? - where()/sort() queries', async (done) => {
...
test('15 -> Server: DELETE /api/collection/:id - Should delete 1 document', async (done) => {
...
test('16 -> Server: DELETE /api/db/collection - Should delete collection', async (done) => {
    setTimeout(async () => {
