 ...
 * ?where=comments,!=,$not                                  --> where('comments != $not') 'comments' field DOES exist
 * ?where=comments,=,$not&where=or&where=tags,=,$not        --> where('comments = $not').or('tags = $not') 'comments' field does NOT exist, OR 'tags' field does NOT exist
 * ?where=comments,=,$not&where=and&where=tags,!=,$not      --> where('comments = $not').and('tags != $not') 'comments' field does NOT exist, AND 'tags' DOES exist
