...
// @desc        Update api route for $collection
// @route       PUT /$api/$collection/:id (id is optional, you can modify this example)
// @access      Public
router.put('/:id', async (req, res) => { 
    ...
    try {
        db.collection(`$collection`).updateOne(id, updates)
            .then(data => {
                res.send(data)
            })
            .catch(e => {
