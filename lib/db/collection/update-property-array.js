...
class UpdateArrayReadable extends Readable {
    ...
    constructor(source, filters, includeParam, pathExpr, updatesArr, timestamps, requestId) {
        super()
    ...
    _read() {
        ...
        try {
            ...
            if (matchesArr) {
                ...
                let updatedDoc = setArrayProperty(propertyPath, doc, matchesArr[propertyPath], this.pathExpr, this.updatesArr, this.timestamps)
                if (updatedDoc) {
                    doc = updatedDoc
...
const updatePropertyArray = (colMeta, filters, includeParam, pathExpr, updatesArr, timestamps) => {
    return new Promise (async (resolve, reject) => {
        ...
        stores.forEach(async (store) => {
            try {
                ...
                const updateArrayReadable = new UpdateArrayReadable(source, filters, includeParam, pathExpr, updatesArr, timestamps, requestId)
...
const setArrayProperty = (propertyPath, docObj, matchesArr, pathExpr, updatesArr, timestamps) => {
