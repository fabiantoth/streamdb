...
const model = (modelName, schema, colMeta) => {
    try {
        ...
        if (colMeta) {
            ...
            const { dbMeta, colMetaPath } = getDbMetaAndColPath(modelPath, modelName)
...
const getDbMetaAndColPath = (modelPath, modelName) => {
