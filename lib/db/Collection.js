    ...
    get() { // get all documents in collection
        return new Promise (async (resolve, reject) => {
            try {
                ...
                resolve({
                    success: true,
                    message: `${data.length} documents found`,
                    data
                })
            } catch (e) {
                reject(e)
    ...
    insertMany(documents) { // add one or more documents to collection
        return new Promise (async (resolve, reject) => {
            try {
                ...
                resolve({
                    success: true,
                    message: `${response.length} documents created successfully`,
                    data: response
                })
            } catch (e) {
                reject(e)
    ...
    updateOne(update) { // update a single document
        return new Promise(async (resolve, reject) => {
            try {
                ...
                resolve({
                    success: true,
                    message: `Document ${res.id} updated successfully`,
                    data: res
                })
            } catch (e) {
                reject(e)
    ...
    updateMany(updates) { // update one or more documents
        return new Promise(async (resolve, reject) => {
            try {
                ...
                resolve({
                    success: true,
                    message: `${res.length} documents updated successfully`,
                    data: res
                })
            } catch (e) {
                reject(e)
    ...
    deleteOne(id) { // delete a single document from collection by id
        return new Promise (async (resolve, reject) => {
            try {
                ...
                resolve({
                    success: true,
                    message: `Document with id "${deletedId}" has been removed`,
                    data: deletedId
                })
            } catch (e) {
                reject(e)
    ...
    deleteMany(idsArray) { // delete one or more documents from collection
        return new Promise (async (resolve, reject) => {
            try {
                ...
                resolve({ success: true, data: deletedIds })
            } catch (e) {
                reject(e)
            }
        })
    ...
    find() { // runs query chain
        return new Promise (async (resolve, reject) => {
            try {
                ...
                resolve({
                    success: true,
                    message: `Found ${data.length} matching results`,
                    data
                })
            } catch (e) {
                reject(e)
