...
SchemaDate.prototype.validate = function (value) {
    if (value === undefined || value === null) {
        ...
        if (typeof value !== 'string' && valueType !== '[object Date]') {
            throw new CustomError('VALIDATION_ERROR', `Expected property '${this.field}' to be type date or null, received: ${typeof value}`)
        }  
        ...
        if (typeof value === 'string') {
            ...
            if (value == 'Invalid Date') {
                throw new CustomError('VALIDATION_ERROR', `Expected property '${this.field}' to be type date or null, received: ${type}`)
            }
        }
    }
