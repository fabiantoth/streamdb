                    ...
                    if (objectField === null) {
                        ...
                        if (objectField) {
                            ...
                            // [$ref] Embed
                                ...
                                taskId_or_ref = addArrayRefsEmbeds(path, objectField, schemaField.embeddedType, dbName, requestId)
                            }
            ...
            if (objectField === null) {
                ...
                if (objectField) {
                    ...
                    // [$ref] Embed
                        ...
                        taskId_or_ref = addArrayRefsEmbeds(nestedPath, objectField, schemaField.embeddedType, dbName, requestId)
                    }
