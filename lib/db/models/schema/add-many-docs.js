                ...
                // handle nested $ref Obj document
                    ...
                    if (objectField) {
                        ...
                        if ('$ref' in objectField) {
                            ...
                            const docInstance = getRefInstance(field, objectField, model.colMeta.dbName, schemaField)
                            if (docInstance) {
                            ...
                            if (objectField.length) {
                                objectField.forEach(docObj => {
                                    if ('$ref' in docObj) {
                                        ...
                                        // empty arrays if $ref objects given directly
                                        docsArray = [] // TODO: case where combination is provided, including ids
                                    }
                                })
                            }

                            // subDocs to be created, create $ref obj for parent field
                            if (docsArray.length) {
