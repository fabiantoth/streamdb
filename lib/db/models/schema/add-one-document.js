                ...
                if (schemaField === null) {
                    ...
                    if (Object.prototype.toString.call(objectField) === '[object Object]') {
                        if (!('$ref' in objectField)) {
                            ...
                            const refModel = await schemaField.getModel(schemaField.params.collection, model.colMeta.colPath).catch(e => { throw new Error(e) })
                            ...
                            if (objectField.id) {
                                ...
                                let refResult = await createSchemaDocument(objectField, refModel).catch(e => { throw new Error(e) })
