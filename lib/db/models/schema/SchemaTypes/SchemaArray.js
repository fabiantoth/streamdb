...
SchemaArray.prototype.setEmbedOptions = function () {
    ...
    // SchemaTypes --> [String,Number,Boolean,Date,Array,Any]
    if (typeof embedded === 'function') {
        const allowedFns = [String, Number, Boolean, Date, Array, Any]
    ...
    if (this.embeddedType.instance === 'nestedObject') {
        ...
        values.forEach(value => {
            if (Object.prototype.toString.call(value) !== '[object Object]') {
                ...
                let obj = {}
                obj = this.embeddedType.validate(value, this.embeddedType.isStrict)
        ...
        values = values.map(value => {
            if (this.embeddedType.instance === 'document') {
                let validDoc = this.embeddedType.addOne(value)
                if (validDoc) {
                    return value
                }
