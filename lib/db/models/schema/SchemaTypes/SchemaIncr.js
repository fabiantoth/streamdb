...
class SchemaIncr extends $incr {
    ...
    constructor(field, params, vModel) {
        ...
        this.field = field
        this.params = params
        this.min = vModel.idCount || 0
        this.max = vModel.idMaxCount || 10000
        this.instance = '$incr'
...
SchemaIncr.prototype.validate = function (idCount, colMeta, exists) {
    ...
    if (idCount > this.max) {
        throw new CustomError('VALIDATION_ERROR', `$incr value cannot be greater than the idMaxCount of: ${this.max}`)
    }
