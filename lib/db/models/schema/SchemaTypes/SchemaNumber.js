...
SchemaNumber.prototype.setTypeOptions = function () {
    ...
    for (let param in this.params) {
        ...
        if (param === 'required') {
            ...
            if (this.params.required && this.params.default === null) {
                throw new CustomError('SCHEMA_ERROR', `cannot set default value to null when required is set to true`)
            } 
        }
...
SchemaNumber.prototype.validate = function (value) {
    if (value === undefined || value === null) {
        ...
        if (typeof value !== 'number' && value !== null) {
            throw new CustomError('TYPING_ERROR', `Expected property '${this.field}' to be type number, received: ${typeof value}`)
        }
    }
