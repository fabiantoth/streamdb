    ...
    if (Object.prototype.toString.call(params) === '[object Array]') {
        ...
        if (params.length) {
            if (params[0].modelName) {
                throw new CustomError('SCHEMA_ERROR', `Cannot array embed "${params[0].instance}" instances in nested objects`)
            }
        }
...
NestedObject.prototype.validate = function (obj, strict) {
    ...
    if (Object.prototype.toString.call(obj) !== '[object Object]') {
        throw new CustomError('VALIDATION_ERROR', `Expected '${this.field}' to be an object, received: ${typeof obj}`)
    }
