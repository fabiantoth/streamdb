...
Document.prototype.updateMany = function (docUpdates, currDocs) {
    ...
    let documents = updateManyDocuments(docUpdates, this.model, requestId, currDocs) || []
    this.clearRequestInfo()
...
Document.prototype.saveOneUpdate = function (data) {
    return new Promise(async (resolve, reject) => {
        ...
        try {
            let result = await saveUpdateOneDocument(this.model.colMeta, data, this.model, true)
            resolve(result)
        } catch (e) {
            reject(e)
        }
...
Document.prototype.saveManyUpdates = function (data) {
    return new Promise(async (resolve, reject) => {
        ...
        try {
            let result = await saveUpdateMany(this.model.colMeta, data, this.model, true)
            resolve(result)
        } catch (e) {
            reject(e)
        }
