        ...
        if (field !== 'id') {
            ...
            // handle document $ref embed
                ...
                if (objectField) {
                    ...
                    let symbols = Object.getOwnPropertySymbols(docObj)
                    if (symbols.length) {
            ...
            // handle nested objects
                ...
                if (objectField) {
                    result = addNestedObject(pathInfo, objectField, schemaField, requestId, settings.strict)
...
const addNestedObject = (pathInfo, nestedObject, objectInstance, requestId, strict) => {
    ...
    for (let nestedField in _TypedSchema) {
        ...
        // handle deeper nested objects...TODO: set replace this with ending 'Any' object?
            ...
            if (objectField) {
                result = addNestedObject(nestedField, objectField, schemaField, requestId, strict)
