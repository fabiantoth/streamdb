            ...
            if (field === 'id') {
                ...
                if (schemaField.instance === 'document') {
                    ...
                    if (objectField === null) {
                        ...
                        const taskObject = addDocEmbedUpdate(field, objectField, schemaField, parentCol, requestId)
        ...
        if (schemaKeys.includes(nestedField)) {
            ...
            if (subSchemaField.instance === 'document') {
                ...
                if (subObjectField === null) {
                    ...
                    const taskObject = addDocEmbedUpdate(nestedPath, subObjectField, subSchemaField, parentCol, requestId)
...
const addDocEmbedUpdate = (path, updateObj, docInstance, parentCol, requestId) => {
